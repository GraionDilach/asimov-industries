...
namespace A.I.NXT
{
    ...
    public class NxtControl
    {
        ...
        public bool MagnetControl(bool magnet)
        {
            ...
            if (magnet == true)
            {
                NXT1MagnetMsg = new byte[] { 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x31, 0x30 };
                NXT2MagnetMsg = new byte[] { 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30 };
            }
            else
            {
              NXT1MagnetMsg = new byte[] { 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x30, 0x31, 0x30 };
